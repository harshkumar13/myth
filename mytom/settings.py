...
Generated by ./manage.py tom_setup on Oct. 1, 2019, 9:15 p.m.
...
SECRET_KEY = '2fqiqvxkfbu@h(=_v&amp;789k5m2t29tf#a()6g@g)dmm&amp;@iut3-!'
...
FACILITIES = {
    'LCO': {
        ...
        'api_key': '7e8eda29e8a1c3474e00b6fc4cef8bcd6d0fbf98',
    },
    'GEM': {
        'portal_url': {
...
TOM_ALERT_CLASSES = ['mytom.my_broker.MyBroker',
...
HOOKS = {
    'target_post_save': 'mytom.hooks.get_info_of_target',
